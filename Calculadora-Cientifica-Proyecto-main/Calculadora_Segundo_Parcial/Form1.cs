    ...
    public partial class Form1 : Form
    {
        ...
        private void Igual_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //PantallaResultados.Text = Interpreter(PantallaEcuacion.Text);
            }
        }
        ...
        private void ClearError_Click(object sender, EventArgs e)
        {
            ...
            else if(PantallaEcuacion.Text.Length!=0)
            {
                ...
                if (PantallaEcuacion.Text[len-1] == 'n' || PantallaEcuacion.Text[len - 1] == 'g' || PantallaEcuacion.Text[len - 1] == 's'
                    || PantallaEcuacion.Text[len - 1] == 'h')
                {
                    while(true)
                    {
                        PantallaEcuacion.Text = PantallaEcuacion.Text.Remove(len-1);
                        len = PantallaEcuacion.Text.Length;
                        if (Is_Number(PantallaEcuacion.Text[len - 1]) || Is_OperadorBas(PantallaEcuacion.Text[len - 1])|| PantallaEcuacion.Text[len - 1]=='-')
                            break;
